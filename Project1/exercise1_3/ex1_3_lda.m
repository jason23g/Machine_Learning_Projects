...
% Get the projected data for each class
PROJECTED_IRIS1 = meas_reduced(iris_labels == 0,:);			%Samples of Class 0
PROJECTED_IRIS2 = meas_reduced(iris_labels == 1,:);			%Samples of Class 1
PROJECTED_IRIS3 = meas_reduced(iris_labels == 2,:);			%Samples of Class 2
...
plot(PROJECTED_IRIS1(:, 1), PROJECTED_IRIS1(:, 2), 'bo');
plot(PROJECTED_IRIS2(:, 1), PROJECTED_IRIS2(:, 2), 'rs');
plot(PROJECTED_IRIS3(:, 1), PROJECTED_IRIS3(:, 2), 'g+');
