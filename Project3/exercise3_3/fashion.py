...
model_plot = model.fit(train_images, train_labels, epochs=400, validation_data=(test_images, test_labels))
...
plt.plot(model_plot.history['accuracy'])
plt.plot(model_plot.history['val_accuracy'])
