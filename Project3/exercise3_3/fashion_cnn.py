...
train_images_reshaped = tf.reshape(train_images, [num_train_images, 28, 28, 1])# reshape to mum_train_images X height X width X channels, where channels = 1
test_images_reshaped = tf.reshape(test_images, [num_test_images, 28, 28, 1])# reshape
